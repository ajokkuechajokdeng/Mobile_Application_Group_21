...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Stream to get foods from Firestore
  final Stream<QuerySnapshot> dbfoods =
      FirebaseFirestore.instance.collection('Food').snapshots();

  // Stream to get popular items from Firestore
  final Stream<QuerySnapshot> dbpopulars =
                        ...
                        StreamBuilder<QuerySnapshot>(
                          ...
                          builder: (BuildContext context,
                            ...
                            if (snapshot.data!.docs.isEmpty) {
                              return const Center(
                                  child: Text(
                                      'No popular items found')); // Show message for empty data
                            }
                            // Data is available, display the popular items
                            final data = snapshot.requireData;
